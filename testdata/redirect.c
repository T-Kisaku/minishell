...
t_testdata redir_output(void) {
  // TOKEN LIST
  static t_token token1 = {.value = "echo",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token2 = {.value = "hello",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token3 = {.value = ">", .type = TOKEN_REDIR_OUTPUT};
  static t_token token4 = {.value = "out.txt",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token5 = {.value = "", .type = TOKEN_EOF};
...
t_testdata redir_input(void) {
  // TOKEN LIST
  static t_token token1 = {.value = "cat", .type = TOKEN_UNQUOTED_WORD};
  static t_token token2 = {.value = "<", .type = TOKEN_REDIR_INPUT};
  static t_token token3 = {.value = "out.txt",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token4 = {.value = "", .type = TOKEN_EOF};
...
t_testdata redir_append(void) {
  ...
  static t_token token1 = {.value = "echo",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token2 = {.value = "bye", .type = TOKEN_UNQUOTED_WORD};
  static t_token token3 = {.value = ">>", .type = TOKEN_REDIR_APPEND};
  static t_token token4 = {.value = "out.txt",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token5 = {.value = "", .type = TOKEN_EOF};
  static t_list token_list5 = {.content = (void *)&token5, .next = NULL};
...
t_testdata redir_mix(void) {
  ...
  static t_token token3 = {.value = "out.txt",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token4 = {.value = ">", .type = TOKEN_REDIR_OUTPUT};
  static t_token token5 = {.value = "new.txt",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token6 = {.value = "", .type = TOKEN_EOF};
...
t_testdata pipe_to_redir(void) {
  ...
  static t_token token1 = {.value = "echo",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token2 = {.value = "test",
                                   .type = TOKEN_SINGLE_QUOTED_WORD};
  static t_token token3 = {.value = "|", .type = TOKEN_PIPE};
  static t_token token4 = {.value = "cat", .type = TOKEN_UNQUOTED_WORD};
  static t_token token5 = {.value = ">", .type = TOKEN_REDIR_OUTPUT};
  static t_token token6 = {.value = "result.txt",
                                   .type = TOKEN_UNQUOTED_WORD};
  static t_token token7 = {.value = "", .type = TOKEN_EOF};
